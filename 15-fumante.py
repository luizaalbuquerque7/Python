# Escreva um programa para calculara redução do tempo de vida de um fumante.
# Pergunte a quantidade de cigarros fumados por dia e quantos anos ele já
# Fumou, Considere que um fumante perede 10 minutos de vida a cada cigarro,
...
redução_em_mintos = anos_fumando * 365 * cigarros_por_dia*10
# Um dia tem 24 x 60 minutos
redução_em_dias = redução_em_mintos / (24 * 60)
